...
export const InstructorChatScreen = ({ route }: Props) => {
  ...
  const renderMessage = ({ item }: { item: MessageOut }) => {
    ...
    return (
      <View style={[
        ...
        {/* Avatar para mensagens recebidas (esquerda) - Aluno */}
        {!isSentByMe && (
          <Avatar.Text
            size={36}
            label="AL"
        ...
        {/* Avatar para minhas mensagens (direita) - Instrutor */}
        {isSentByMe && (
          <Avatar.Text
            size={36}
            label="EU"
  ...
  return (
    ...
    >
      ...
      <View style={styles.header}>
        <Text style={styles.headerTitle}>Chat com Aluno</Text>

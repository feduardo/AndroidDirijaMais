...
const CNH_CATEGORIES = [
  ...
  { value: 'B', label: 'B (Carro de passeio)' },
  { value: 'C', label: 'C (Caminhões leves)' },
  { value: 'D', label: 'D (Ônibus/vans)' },
  { value: 'E', label: 'E (Veículos articulados)' },
  { value: 'AB', label: 'AB (Moto + Carro)' },
];

export const RegisterInstructorScreen = () => {
  ...
  const validateForm = (): boolean => {
    ...
    // Validações específicas do instrutor
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <Text variant="bodyMedium" style={styles.subtitle}>
          Crie sua conta e configure seu perfil depois
        </Text>
